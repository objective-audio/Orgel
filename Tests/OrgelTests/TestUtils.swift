...
extension Entity.Name {
    static let objectA: Entity.Name = ObjectA.entity.name
    static let objectB: Entity.Name = ObjectB.entity.name
    static let objectC: Entity.Name = ObjectC.entity.name
}
